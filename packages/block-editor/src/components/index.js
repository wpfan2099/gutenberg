...
export {
	default as __experimentalPanelColorGradientSettings,
	ColorGradientSettings as __experimentalColorGradientSettings,
} from './colors-gradients/panel-color-gradient-settings';
